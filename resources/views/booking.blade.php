                            ...
                            <form name="contactForm" id='contact_form' method="post">
                                <div id="step-1" class="row">
                                    <div class="col-md-12 mb10">
                                        ...
                                        <div class="guests-n-rooms">
                                            <h4>Immobiliengröße</h4>
                                            <p>
                                                Für wie viele Wohneinheiten dürfen wir 3D Grundrisse für Sie anfertigen?
                                                Bei einer Wohneinheit mit mehreren Stockwerken, wird jedes Stockwerk als einzelne Wohneinheit gezählt.  
                                            </p>
                                            <input type="number" class="form-control" id="qty" value="1" min="1">
                                            <p>
                                                Wie viele der Wohneinheiten verfügen über mehr als 100QM Wohnfläche pro
                                                Stockwerk?
                                            </p>
                                            <input type="number" class="form-control" id="mqQty" value="0" min="0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="checkbox" id="lp"> Hinzufügen Ihres Logos  4€
                                    </div>
