                ...
                <div class="row">
                    <div class="col-lg-6 offset-lg-3">
                        <div class="de-content-overlay">
                            <h2 class="form-h">Vielen Dank für Ihren Auftrag!</h2>
                            <p class="form-h">
                                Sie haben die Details Ihrer Bestellung erfolgreich übergeben.
                            </p>

                            <a href="{{ route('auftragsdetails') }}" class="btn btn-line"> zur Startseite</a>
