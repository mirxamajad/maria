                        ...
                        <div class="de-content-overlay">
                            ...
                            <form name="contactForm" id='contact_form' method="post">
                                            ...
                                            <div style="background-size: cover;">
                                                ...
                                                <div class="form-group">
                                                    <input type="radio" name="Name" id="" placeholder="Firma" required="">
                                                    <label for="">Ich habe eine Vorstellung, wie es aussehen soll</label>
                                                </div>
                                            </div>
                                            <div style="background-size: cover;">
                                            ...
                                            <div style="background-size: cover; mar" class="form-group">
                                                <label style="background-size: cover;" for="accessories">  Accessoires einfügen </label>
                                                <input type="text" name="accessories" id="accessories" class="form-control" placeholder="(z.B. Handtücher, Pfannen, Pflanzen etc.):" required="">
                                            </div>
                                            <div style="background-size: cover; mar" class="form-group">
                                                <label style="background-size: cover;" for="format">  Gewünschtes Format der fertigen Datei </label>
